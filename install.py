...
def test_mcp_server(mcp_path, python_cmd):
    ...
    try:
        ...
        if "squeeze_compress" in stdout and "squeeze_skeleton" in stdout:
            return True, "8 tools verified (squeeze_codebase_graph, squeeze_skeleton, squeeze_compress, squeeze_shrink_json, squeeze_shrink_logs, squeeze_retrieve, squeeze_cache_align, squeeze_stats)"
